...
import { postPayload } from "../../../../support/factories/api/fakerApi/Activities/index"


describe("POST - Activities", () => {
    context("Validar retornos sucesso", () => {
        ...
        it("Validar respostas do corpo da requisição", () => {
            Activities.postActivities(postPayload.payload).should(response => {
    ...
    context("Validar retornos com erros", () => {
        it("Validar status code", () => {
